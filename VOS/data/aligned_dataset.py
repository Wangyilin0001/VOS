    ...
    def initialize(self, opt, line = 0, epoch =1,two = 1):
        ...
        if two == 1 and len(AlignedDataset.l1_results_3)==0:
            ...
            if AlignedDataset.l1_results.size <= 1:
                ...
                AlignedDataset.l1_results_3 = AlignedDataset.l1_results[-1:]  # 如果元素个数大于3，则赋值为results的最新三个值
                AlignedDataset.l2_results_3 = AlignedDataset.l2_results[-1:]  # 如果元素个数大于3，则赋值为results的最新三个值
