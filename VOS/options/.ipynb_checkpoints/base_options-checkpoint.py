...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--which_model_netG1', type=str, default='resnet_9blocks', help='selects model to use for netG')
        parser.add_argument('--which_model_netG2', type=str, default='resnet_9blocks', help='selects model to use for netG')
        parser.add_argument('--which_model_netD1', type=str, default='basic_D1', help='selects model to use for netD')
        parser.add_argument('--which_model_netD2', type=str, default='basic_D2', help='selects model to use for netD')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default=r'.\checkpoints\\', help='models are saved here')
        ...
        parser.add_argument('--w_step', default=10, help='weight of the step loss')  # 滑动损失系数吗，通用10
        ...
        # 自己修改参数
        parser.add_argument('--train_number', default=1, help='每几轮保存一下模型')
