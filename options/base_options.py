...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', type=str, default=r'E:\GAN-NET\dataset\FLIR_wash_day',help='path to images (should have subfolders train, val, etc)')
        ...
        parser.add_argument('--which_model_netG1', type=str, default='TICC_GAN_G1', help='selects model to use for netG,pix2pix,MSUNet_G1,LK_GAN_G1,TICC_GAN_G1')
        parser.add_argument('--which_model_netG2', type=str, default='TICC_GAN_G2', help='selects model to use for netG,pix2pix,MSUNet_G2,LK_GAN_G2,TICC_GAN_G2')
        ...
        parser.add_argument('--model', type=str, default='CDGAN',
                            help='chooses which model to use. cycle_gan, pix2pix, test，CDGAN')   # ----VOS对抗网络
        ...
        parser.add_argument('--w_step', default=1, help='weight of the step loss')  # 滑动损失系数吗，通用1
